        ...
        else 
        {
            ...
            else
            {
                ...
                if ($inadmin === true) {
                    ...
                    $link = "http://www.yagamistore.com.br/admin/forgot/reset?code=$code";

                } else {
                    $link = "http://www.yagamistore.com.br/forgot/reset?code=$code";
                }

                $mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir Senha da Yagami Store", "forgot", 
                    array(
                    "name"=>$data["desperson"],
                    "link"=>$link
                ));
